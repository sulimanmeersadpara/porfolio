  ...
  return (
    ...
    <section id="about" className="scroll-mt-28">
      <div className="flex flex-col gap-[10px]">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-[10px]">
       ...
       <div className="h-full space-y-[10px]">
         ...
         <div className="flex w-full flex-col gap-[10px]">
           ...
           <div className="mx-5">
            ...
            <div className="grid gap-[10px] sm:grid-cols-1 md:grid-cols-2">
              <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-5">
                ...
                <p className="mt-2 text-sm text-[#00255B]/65 sm:text-base lg:text-lg">University of Baltistan · 2022 – 2025</p>
              </div>
              <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-5">
                <p className="font-semibold text-[#00255B]">4xCode Software House</p>
                <p className="mt-2 text-sm text-[#00255B]/65 sm:text-base lg:text-lg">I work as a Full Stack Software Engineer, building and maintaining web applications for different projects and clients.</p>
              </div>
            </div>
            </div>
          </GlassCard>
