      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
          ...
          <GlassCard className="space-y-6">
            ...
            <p className="text-lg leading-8 text-[#00255B]/70">I have spent a lot of time building my foundation in DSA, OOP, practice questions, and logic building. I enjoy turning ideas into real-world applications with strong engineering discipline and clean execution. My focus is not just on writing code, but on creating products that are reliable, user-friendly, and maintainable.</p>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-4">
                <p className="text-sm uppercase tracking-[0.28em] text-[#00255B]">Core stack</p>
                <p className="mt-2 font-semibold text-[#00255B]">Python Django, Next.js, React.js</p>
              </div>
              <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-4">
                <p className="text-sm uppercase tracking-[0.28em] text-[#00255B]">Approach</p>
                <p className="mt-2 font-semibold text-[#00255B]">Thoughtful, production-ready, and user-focused</p>
              </div>
            </div>
            <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-4">
              <p className="text-sm uppercase tracking-[0.28em] text-[#00255B]">Selected skills</p>
              <div className="mt-3 flex flex-wrap gap-2">
                {['Python', 'JavaScript', 'React.js', 'Next.js', 'Django', 'DRF', 'Tailwind CSS', 'SQL', 'GitHub'].map((skill) => (
                  <span key={skill} className="rounded-full border border-[#00255B]/15 bg-white px-3 py-1 text-sm text-[#00255B]">{skill}</span>
                ))}
              </div>
            </div>
          </GlassCard>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-6">
          <GlassCard className="space-y-6">
            ...
            <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-5">
              ...
              <p className="mt-2 text-[#00255B]/65">University of Baltistan · Completed in 2025</p>
            </div>
            <div className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-5">
              <p className="font-semibold text-[#00255B]">Internship and current work at 4xcode Software House</p>
              <p className="mt-2 text-[#00255B]/65">I completed my internship at 4xcode and am currently doing my job there as a Full Stack Developer, contributing to production-ready digital products.</p>
            </div>
          </GlassCard>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <GlassCard className="space-y-5">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {journey.map((item) => (
              <div key={item.title} className="rounded-[10px] border border-[#00255B]/15 bg-[#00255B]/5 p-4">
                <div className="flex items-center gap-2 text-[#00255B]"><FaCode /> <span className="font-semibold">{item.title}</span></div>
                <p className="mt-2 text-sm leading-7 text-[#00255B]/65">{item.text}</p>
              </div>
            ))}
          </div>
